...
var readFeatureCollection = module.exports = function (featureCollection, options, changeset, idGenerator, options) {
  ...
  geojsonFeatures.forEach(function (feature) {
    ...
    if (feature.type === 'Feature') {
      ...
      if (geometryType) {
        osmFeatures.push(geometryType(osmId, changeset, osmVersion, feature.geometry, feature.properties, idGenerator, options));
      } else {
        throw new Error('Invalid Geometry Type: ' + feature.geometry.type);
      }
    } else if (feature.type === 'FeatureCollection') {
      osmFeatures.concat(readFeatureCollection(feature, options, changeset, idGenerator, options));
    } else {
